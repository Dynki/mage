...
import { CollectionWithNftSetCount } from "../utils/computed-properties";
...
type CollectionStore = {
  ...
  setCollection: (newCollection: CollectionWithNftSetCount) => void;
...
export const useCollectionStore = create<CollectionStore>((set) => ({
    ...
    setCollection: (newCollection: CollectionWithNftSetCount) => set(({ collection }) => {
