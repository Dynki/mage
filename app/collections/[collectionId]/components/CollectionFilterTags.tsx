...
import { Tag } from "@/lib/components/controls/Tag";
...
export const CollectionFilterTags = (props: CollectionFilterTagsProps) => {
  ...
  const handleTagClosed = useCallback((propertyKey: string, ids: string[] | undefined) => {
  ...
  const handleSearchValueClosed = useCallback((searchValue: string) => {
